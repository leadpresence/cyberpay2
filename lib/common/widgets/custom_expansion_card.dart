library custom_expansion_tile_card;
...
class CustomExpansionTileCard extends StatefulWidget {
  ...
  const CustomExpansionTileCard({
    ...
    this.headerShadowColor = const Color(0xffaaaaaa),
                ...
                child: ListTileTheme.merge(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color:widget.headerShadowColor ?? Color(0xFFFBF4F3),
