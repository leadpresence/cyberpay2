...
import 'dio_interceptor/cache_interceptor.dart';
...
class DioHttpService implements HttpService {
  ...
  DioHttpService(
      this.storageService, {Dio? dioOverride, bool enableCaching = true}) {
  ...
  BaseOptions get baseOptions => BaseOptions(baseUrl: baseUrl, headers: headers);
